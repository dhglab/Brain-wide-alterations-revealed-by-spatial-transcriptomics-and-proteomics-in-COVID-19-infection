...
save(EWCE_enrichment,EWCE_contingency,background,file= "FrontalGM56_downBakkenEWCE-Enrichment-P_SizeBiased.RData")
...
save(EWCE_enrichment,EWCE_contingency,background,file= "FrontalGM56_up_BakkenEWCE-Enrichment-P_SizeBiased.RData")
...
save(EWCE_enrichment,EWCE_contingency,background,file= "FrontalWM56_downBakkenEWCE-Enrichment-P_SizeBiased.RData")
...
save(EWCE_enrichment,EWCE_contingency,background,file= "FrontalWM56_up_BakkenEWCE-Enrichment-P_SizeBiased.RData")
...
COVID_down_Bakken <- rbind (FrontalGM56_down_cell, FrontalWM56_down_cell)
save(COVID_down_Bakken, file = "COVID_down_Bakken_level2.Rdata")
write.csv(COVID_down_Bakken, file = "COVID_down_Bakken_level2.csv")

COVID_up_Bakken <- rbind (FrontalGM56_up_cell, FrontalWM56_up_cell)
save(COVID_up_Bakken, file = "COVID_up_Bakken_level2.Rdata")
write.csv(COVID_up_Bakken, file = "COVID_up_Bakken_level2.csv")

#The results are input files for Figure 1_G2