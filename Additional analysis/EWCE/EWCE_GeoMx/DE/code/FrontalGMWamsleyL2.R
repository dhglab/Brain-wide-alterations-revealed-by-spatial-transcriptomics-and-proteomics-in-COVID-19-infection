...
save(FrontalGM56_down_cell, file="FrontalGM56_down_cell_Wamsley_level2.Rdata")
FrontalGM56_down_cell_fdr <- subset(FrongalGM56_down_cell, FDR < 0.05)
write.csv(FrontalGM56_down_cell_fdr, file = "COVID_down_Wamsley_FrontalGM_level2.csv")
