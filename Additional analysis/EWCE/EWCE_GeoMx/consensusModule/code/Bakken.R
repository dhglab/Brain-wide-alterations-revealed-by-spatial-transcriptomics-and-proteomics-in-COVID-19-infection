...
COVIDmodule_bakken <- rbind(black_p, blue_p,	brown_p,	cyan_p,	darkgreen_p,
...
save(COVIDmodule_bakken, file= "COVIDmodule_bakken_level2.Rdata")
write.csv(COVIDmodule_bakken, file="COVIDModules_celltype_Bakken_level2.csv")

#Results are input files for Extended Figure 4C