...
COVIDmodule <- rbind(black_p, blue_p,	brown_p,	cyan_p,	darkgreen_p,
...
save(COVIDmodule, file= "COVIDmodule_Wamsley_level1.Rdata")
write.csv(COVIDmodule, file="COVIDModules_Wamsley_level1.csv")

#Results are input files for Extended Figure 4B